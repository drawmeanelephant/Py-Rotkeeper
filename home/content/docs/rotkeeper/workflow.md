...
# 🔄 Rotkeeper Workflow Overview

This document provides a comprehensive guide to the Rotkeeper CLI workflow, detailing each ritual from initializing a new repository to packing and scanning archives. Each step corresponds to a specific script (`rc-*.sh`) that automates part of the content management and packaging process.
